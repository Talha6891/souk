...
@section('content')
<body
    class="flex items-center justify-center min-h-screen px-4 py-15 bg-cover bg-auth-pattern dark:bg-auth-pattern-dark dark:text-zink-100 font-public">
            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-slate-500 dark:text-zink-200">Sign in to continue to Souk.</p>
                    </div>
