        ...
        <div
            ...
            <div
                ...
                <div class="flex gap-3 ms-auto">
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                                class="inline-block p-0 transition-all duration-200 ease-linear bg-topbar rounded-full text-topbar-item dropdown-toggle btn hover:bg-topbar-item-bg-hover hover:text-topbar-item-hover group-data-[topbar=dark]:text-topbar-item-dark group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:hover:bg-topbar-item-bg-hover-dark group-data-[topbar=dark]:hover:text-topbar-item-hover-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:hover:bg-topbar-item-bg-hover-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:hover:bg-zink-600 group-data-[topbar=brand]:text-topbar-item-brand group-data-[topbar=dark]:dark:hover:text-zink-50 group-data-[topbar=dark]:dark:text-zink-200"
                                id="dropdownMenuButton" data-bs-toggle="dropdown">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos() && Auth::user()->profile_photo_url)
                                <div class="bg-pink-100 rounded-full">
                                    <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->first_name }}"
                                         class="w-[37.5px] h-[37.5px] rounded-full">
                                </div>
                            @else
                                <div class="inline-block w-[37.5px] h-[37.5px] rounded-full bg-gray-200 flex items-center justify-center text-gray-700">
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                            ...
                            <a href="#!" class="flex gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 dark:text-zink-300">{{ strtoupper(Auth::user()->roles->first()->name) }}</p>
                                </div>
                            </a>
                            <ul>
                                <li>
